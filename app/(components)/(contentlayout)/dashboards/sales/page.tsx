                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12">
                                <div className="col-span-6 pe-0">
                                    ...
                                    <Link href="#!" scroll={false} className="text-[0.75rem] mb-0 text-primary">Show full stats<i className="ti ti-chevron-right ms-1 inline-flex"></i></Link>
                                </div>
                        ...
                        <div className="card-body !p-0">
                            <div className="list-group">
                                ...
                                <Link href="#!" scroll={false} className="!border-0">
                                    <div className="list-group-item !border-0">
                                        <div className="flex items-start">
                                            <span className="tansaction-icon bg-pinkmain">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div id="salesOverview">
                                <ReactApexChart options={Salesdata.Salesoverview.options} series={Salesdata.Salesoverview.series} type="bar" width={"100%"} height={325} />
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="tab-menu-heading border-0 p-0 ms-auto sm:mt-0 my-2">
                                <div className="tabs-menu-task me-3">
                                    <nav className="" aria-label="Tabs" role="tablist">
                                        <Link href="#!" scroll={false} className="hs-tab-active:bg-secondary/10 hs-tab-active:text-secondary cursor-pointer text-defaulttextcolor px-4 py-2 flex-grow  text-[0.75rem] font-medium text-center rounded-md hover:text-secondary active" id="active-item" data-hs-tab="#Active" aria-controls="Active">
                                            Active Tasks
                                        </Link>
                                        <Link href="#!" scroll={false} className="hs-tab-active:bg-secondary/10 hs-tab-active:text-secondary cursor-pointer text-defaulttextcolor px-4 py-2 text-[0.75rem] flex-grow font-medium text-center  rounded-md hover:text-secondary " id="Complete-item" data-hs-tab="#Complete" aria-controls="Complete">
                                            Completed Tasks
                                        </Link>
                                    </nav>
                                </div>
                                        ...
                                        <table className="table whitespace-nowrap table-hover min-w-full">
                                            ...
                                            <tbody>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    <td className="text-center">
                                                        <span>
                                                            <input className="form-check-input" type="checkbox" id="check2" defaultValue="" aria-label="..." defaultChecked />
                                                        </span>
                                                    </td>
                                        ...
                                        <table className="table whitespace-nowrap table-hover min-w-full">
                                            ...
                                            <tbody>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    <td className="text-center">
                                                        <span>
                                                            <input className="form-check-input" type="checkbox" id="check29" defaultValue="" aria-label="..." />
                                                        </span>
                                                    </td>
                                                ...
                                                <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                    <td className="text-center">
                                                        <span>
                                                            <input className="form-check-input" type="checkbox" id="check9" defaultValue="" aria-label="..." />
                                                        </span>
                                                    </td>
                        ...
                        <div className="box-header">
                            ...
                            <div className="tab-menu-heading !border-0 !p-0 ms-auto">
                                <div className="tabs-menu-billing my-1">
                                    <nav className="" aria-label="Tabs" role="tablist">
                                        <Link href="#!" scroll={false} className="hs-tab-active:bg-success/10 hs-tab-active:text-success text-defaulttextcolor py-[0.35rem] px-4 flex-grow  text-[0.75rem] font-medium text-center rounded-md hover:text-success active" id="Invoice-item" data-hs-tab="#Invoice" aria-controls="Invoice">
                                            Invoices
                                        </Link>
                                        <Link href="#!" scroll={false} className="hs-tab-active:bg-success/10 hs-tab-active:text-success text-defaulttextcolor py-[0.35rem] px-4 text-[0.75rem] flex-grow font-medium text-center  rounded-md hover:text-success " id="Revenue-item" data-hs-tab="#Revenue" aria-controls="Revenue">
                                            Revenue
                                        </Link>
                                    </nav>
                                </div>
                    ...
                    <div className="box">
                        ...
                        <div className="box-body !p-0 px-1">
                            <div id="sale-value" className="p-5">
                                <ReactApexChart options={Salesdata.Salevalue.options} series={Salesdata.Salevalue.series} type="radialBar" width={"100%"} height={233} />
                            </div>
                                ...
                                <table className="table whitespace-nowrap table-bordered min-w-full">
                                    <thead>
                                        <tr>
                                            <td>
                                                <span>
                                                    <input className="form-check-input" type="checkbox" id="order_1" defaultValue="" aria-label="..." />
                                                </span>
                                            </td>
