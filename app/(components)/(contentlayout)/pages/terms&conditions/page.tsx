                                ...
                                <div>
                                    <div className="!ps-0 form-check !flex">
                                        ...
                                        <label className="ps-3 form-check-label text-defaulttextcolor/70 inline-block" htmlFor="privacy-policy">
                                            I agree with the <Link href="#!" scroll={false} className="font-semibold text-defaulttextcolor/70"><u>Privacy Policy</u></Link>
                                        </label>
                                    </div>
                                    <div className="!ps-0 form-check !flex">
                                        ...
                                        <label className="ps-3 form-check-label text-defaulttextcolor/70 inline-block" htmlFor="terms_conditions">
                                            I agree with the <Link href="#!" scroll={false} className="font-semibold text-defaulttextcolor/70"><u>Terms &amp; Conditions</u></Link>
                                        </label>
                                    </div>
                                </div>
