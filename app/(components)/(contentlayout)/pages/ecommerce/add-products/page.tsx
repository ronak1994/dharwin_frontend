"use client"
import { Addproduct, Addproduct1, Addproduct2, Addproduct3, Addproduct4, Addproduct5, Addproduct6, Addproduct7} from '@/shared/data/pages/ecommerce/addproductsdata';
                                    ...
                                    <div className="xxl:col-span-6 xl:col-span-12 lg:col-span-12 md:col-span-6 col-span-12">
                                        <div className="grid grid-cols-12 gap-4">
                                            ...
                                            <div className="xl:col-span-6 col-span-12">
                                                ...
                                                <Select  options={Addproduct1} className="w-full !rounded-md" isSearchable id="product-gender-add"
                                            ...
                                            <div className="xl:col-span-12 col-span-12 mb-4">
                                                ...
                                                <div id="product-features">
                                                    <TiptapEditor placeholder="Enter product features..." />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="xxl:col-span-6 xl:col-span-12 lg:col-span-12 md:col-span-6 col-span-12">
                                        <div className="grid grid-cols-12 gap-4">
                                            ...
                                            <div className="xl:col-span-6 col-span-12">
                                                ...
                                                <DatePicker selected={startDate} onChange={handleDateChange} className='rounded-sm'/>
                                            </div>
                                            <div className="xl:col-span-6 col-span-12">
