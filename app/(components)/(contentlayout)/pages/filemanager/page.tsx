                    ...
                    <div className="flex items-center justify-between w-full p-4 border-b dark:border-defaultborder/10">
                        ...
                        <div className="hs-dropdown ti-dropdown">
                            ...
                            <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Hidden Files</Link></li>
                                <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Another action</Link></li>
                                <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Something else here</Link></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className={`file-manager-folders ${isFoldersOpen ? 'open' : ''}`}>
                    <div className="flex p-4 flex-wrap gap-2 items-center justify-between border-b dark:border-defaultborder/10">
                        ...
                        <div className="flex gap-2">
                            ...
                            <div>
                                <Link href="#!" scroll={false} className="hs-dropdown-toggle ti-btn !gap-0 !py-1 !px-2 !text-[0.75rem] !font-medium bg-secondary text-white flex items-center justify-center" data-hs-overlay="#todo-compose2">
                                                ...
                                                <div>
                                                    <div className="hs-dropdown ti-dropdown ltr:[--placement:left-top] rtl:[--placement:right-top]">
                                                        ...
                                                        <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                                            ...
                                                            <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Hide Folder</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <td colSpan={5}>
                                                    <nav aria-label="Page navigation" className="flex justify-end">
                                                        <ul className="ti-pagination  mb-0">
                                                            ...
                                                            <li className="page-item"><Link className="page-link px-3 py-[0.375rem]" href="#!" scroll={false}>1</Link></li>
                    ...
                    <div className="flex p-4 items-center justify-between border-b dark:border-defaultborder/10">
                        ...
                        <div className="flex items-center">
                            <div className="hs-dropdown ti-dropdown me-1">
                                ...
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Share</Link></li>
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Copy</Link></li>
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Move</Link></li>
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Delete</Link></li>
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Raname</Link></li>
                                </ul>
                            </div>
