...
const Mailapp = () => {
    ...
    const Close = () => {
        const mailinformation = document.querySelector(".mails-information") as HTMLDivElement;
        if (innerWidth <= 1399) {
                ...
                <div className="main-mail-container !p-2 gap-x-2 flex">
                    <div className={`mail-navigation ${isMailNavigationVisible ? '!block' : ''} border dark:border-defaultborder/10`}>
                        <div className="grid items-start !p-4 border-b dark:border-defaultborder/10">
                            <Link href="#!" scroll={false} className="hs-dropdown-toggle ti-btn !bg-success text-white flex items-center justify-center !font-medium" data-hs-overlay="#todo-compose"><i className="ri-add-circle-line text-[1rem] align-middle"></i>Compose Mail
                            </Link>
                                                ...
                                                <div className="xl:col-span-12 col-span-12">
                                                    ...
                                                    <div className="mail-compose">
                                                        <div id="mail-compose-editor">
                                                            <TiptapEditor placeholder="Compose your email..." />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <ul className="list-none mail-main-nav !text-[0.813rem]" id="mail-main-nav">
                                    <li className="!px-0 !pt-0">
                                        ...
                                        {Mails.map((idx) => (
                                          ...
                                          <li className="px-0">
                                        <span className="text-[.6875rem] text-[#8c9097] dark:text-white/50 opacity-[0.7] font-semibold">SETTINGS</span>
                                    </li>
                                    <li>
                                        <Link href="#!" scroll={false}>
                                            <div className="flex items-center">
                                                <span className="me-2 leading-none">
                                                    <i className="ri-settings-3-line align-middle text-[.875rem]"></i>
                                                </span>
                                                <span className="flex-grow whitespace-nowrap">
                                                    Settings
                                                </span>
                                    ...
                                    <li className="px-0">
                                        <span className="text-[.6875rem] text-[#8c9097] dark:text-white/50 opacity-[0.7] font-semibold">LABELS</span>
                                    </li>
                                    <li>
                                        <Link href="#!" scroll={false}>
                                            <div className="flex items-center">
                                                <span className="me-2 leading-none">
                                                    <i
                                                        className="ri-price-tag-line align-middle text-[.875rem] font-semibold text-secondary"></i>
                                                </span>
                                                <span className="flex-grow whitespace-nowrap">
                                                    Mail
                                                </span>
                                    ...
                                    <li>
                                        <Link href="#!" scroll={false}>
                                            <div className="flex items-center">
                                                <span className="me-2 leading-none">
                                                    <i
                                                        className="ri-price-tag-line align-middle text-[.875rem] font-semibold text-danger"></i>
                                                </span>
                                                <span className="flex-grow whitespace-nowrap">
                                                    Home
                                                </span>
                                    ...
                                    <li>
                                        <Link href="#!" scroll={false}>
                                            <div className="flex items-center">
                                                <span className="me-2 leading-none">
                                                    <i
                                                        className="ri-price-tag-line align-middle text-[.875rem] font-semibold text-success"></i>
                                                </span>
                                                <span className="flex-grow whitespace-nowrap">
                                                    Work
                                                </span>
                                    ...
                                    <li>
                                        <Link href="#!" scroll={false}>
                                            <div className="flex items-center">
                                                <span className="me-2 leading-none">
                                                    <i
                                                        className="ri-price-tag-line align-middle text-[.875rem] font-semibold text-black dark:text-white"></i>
                                                </span>
                                                <span className="flex-grow whitespace-nowrap">
                                                    Friends
                                                </span>
                        ...
                        <div className="!p-4 flex items-center border-b dark:border-defaultborder/10">
                            ...
                            <div className="hs-dropdown ti-dropdown  hidden">
                                ...
                                <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Recent</Link></li>
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Unread</Link></li>
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Mark All Read</Link></li>
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Spam</Link></li>
                                    <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}>Delete All</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="p-4">
                                    ...
                                    {Mails1.map((idx) => (
                                        <li className={`!border-x-0 ${idx.bordercls}`} onClick={() => Medium()} key={Math.random()}>
                                            <div className="flex items-start">
                                                ...
                                                <div className="flex-grow">
                                                    <Link href="#!" scroll={false}>
                                                        <p className="mb-1 text-[0.75rem] space-x-2"> {idx.name} <span className={idx.badge}>{idx.badgetxt}</span>
                                                            <span
                        ...
                        <div className="mail-info-header flex flex-wrap gap-2 items-center">
                            ...
                            <div className="mail-action-icons">
                                <div className="hs-tooltip ti-main-tooltip">
                                    <button type="button" className="hs-tooltip-toggle ti-btn ti-btn-icon ti-btn-light me-2">
                            ...
                            <div className="responsive-mail-action-icons">
                                <div className="hs-dropdown ti-dropdown  hidden me-1">
                                    ...
                                    <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}><i className="inline-flex ri-star-line me-1 align-middle"></i>Starred</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}><i className="inline-flex ri-inbox-archive-line me-1 align-middle"></i>Archive</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}><i className="inline-flex ri-spam-2-line me-1 align-middle"></i>Report Spam</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}><i className="inline-flex ri-delete-bin-line me-1 align-middle"></i>Delete</Link></li>
                                        <li><Link className="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium" href="#!" scroll={false}><i className="inline-flex ri-reply-line me-1 align-middle"></i>Reply</Link></li>
                                    </ul>
                                </div>
                                <button 
                                onClick={() => Close()}
                                 aria-label="button" type="button" className="ti-btn ti-btn-icon ti-btn-light ms-1">
                                    <i className="ri-close-line"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="mail-info-body  dark:!border-defaultborder/10 p-6 overflow-scroll" id="mail-info-body">
                            ...
                            <div className="mail-attachments mb-6">
                                ...
                                <div className="mt-2 flex items-center flex-wrap">
                                    <Link href="#!" scroll={false} className="mail-attachment border dark:border-defaultborder/10 mb-1 me-2">
                                    ...
                                    <Link href="#!" scroll={false} className="mail-attachment border dark:border-defaultborder/10">
                                    ...
                                    <div className="hs-tooltip ti-main-tooltip">
                                            <button type="button" className="hs-tooltip-toggle !w-[2.75rem] !h-[2.75rem] ti-btn-icon ti-btn-outline-light dark:hover:!bg-light 
                                            flex items-center justify-center !rounded-md dark:!border-defaultborder/10 !ms-2 !text-[1.2rem] !text-defaulttextcolor 
                                            dark:!text-defaulttextcolor/70 border">
                            ...
                            <div className="mail-reply dark:border-defaultborder/10">
                                <div id="mail-reply-editor">
                                    <TiptapEditor placeholder="Type your reply..." />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mail-recepients border dark:border-defaultborder/10">
                        <div className="p-4 border-b  dark:border-defaultborder/10">
                            <div className="hs-tooltip ti-main-tooltip !ms-0">
                        ...
                        <div className="p-4 flex flex-column items-center total-mail-recepients overflow-scroll" id="mail-recepients">
                            <div className="hs-tooltip ti-main-tooltip [--placement:left]">
                                <Link href="#!" scroll={false} className="mail-recepeint-person hs-tooltip-toggle">
