...
const Mailsettings = () => {
    ...
    const [selectedImage, setSelectedImage] = useState<string | null>("../../../assets/images/faces/9.jpg"); // Set the default image URL here
                                                ...
                                                <div className="mb-0 me-[3rem]"> 
                                                    <span className="avatar avatar-xxl avatar-rounded">
                                                        ...
                                                        <span aria-label="anchor" className="badge rounded-full bg-primary avatar-badge" onClick={openFileInput}>
                                                            <input type="file" name="photo" data-hs-overlay="#hs-small-modal"  ref={fileInputRef}
                                                ...
                                                <div className="grid grid-cols-12 gap-4">
                                                    ...
                                                    <div className="xl:col-span-5 col-span-12">
                                                        <div className="ltr:sm:float-right rtl:sm:float-left">
                                                            <Link href="#!" scroll={false} className="ti-btn ti-btn-outline-success !py-1 !px-2 !text-[0.75rem]">Learn-more</Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <div className="xl:col-span-3 col-span-12">
                                                <div className="box !shadow-none border dark:border-defaultborder/10">
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                <input className="btn-check"  type="radio" name="label-allmails" id="all-mails-enable" defaultChecked />
                                                                <label className="ti-btn !text-[0.75rem] !font-medium ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="all-mails-enable">Enable</label>
                                                                <input className="btn-check"  type="radio" name="label-allmails" id="all-mails-disable" />
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="inbox-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="sent-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="drafts-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="spam-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="important-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="trash-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="archive-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="starred-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="settings-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="custom-mail-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="home-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="work-enable">Enable</label>
                                                    ...
                                                    <div className="box-body flex items-center justify-between flex-wrap gap-2">
                                                        ...
                                                        <div>
                                                            <div className="inline-flex" role="group" aria-label="Basic radio toggle button group">
                                                                ...
                                                                <label className="ti-btn !text-[0.75rem] !font-medium  ti-btn-outline-primary text-white !rounded-e-none !border-e-0" htmlFor="friends-enable">Enable</label>
