                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                    ...
                                    <DatePicker className="ti-form-input rounded-sm focus:z-10" selected={startDate} onChange={(date) => setStartDate(date as Date)} />
                                </div>
                                <div className="xl:col-span-6 col-span-12">
                                    <label className="form-label">Publish Time</label>
                                    <DatePicker className="ti-form-input rounded-sm focus:z-10" selected={startDate} onChange={(date) => setStartDate(date as Date)} showTimeSelect showTimeSelectOnly timeIntervals={15} timeCaption="Time" dateFormat="h:mm aa" />
                                </div>
                                <div className="xl:col-span-6 col-span-12">
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    ...
                                    <div id="blog-content">
                                        <TiptapEditor placeholder="Write your blog content here..." />
                                    </div>
                                </div>
                                    ...
                                    <li className="list-group-item" key={Math.random()}>
                                        <div className="flex gap-2 flex-wrap items-center">
                                            ...
                                            <div className="flex-grow">
                                                <Link href="#!" scroll={false} className="text-[0.875rem] font-semibold mb-0">{idx.title}</Link>
