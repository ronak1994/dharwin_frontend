                    ...
                    <div className="box">
                        <div className="box-header md:flex block">
                            ...
                            <div className="ms-auto md:mt-0 mt-2">
                                <button type="button" className="ti-btn !py-1 !px-2  text-white !text-[0.75rem] bg-secondary me-2" onClick={() => print()}>Print<i className="ri-printer-line ms-1 align-middle inline-block"></i></button>
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                                        <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12">
                                            ...
                                            <p className="text-[#8c9097] dark:text-white/50">For more information check for <Link href="#!" scroll={false} className="text-primary font-semibold"><u>GSTIN</u></Link> Details.</p>
                                        </div>
