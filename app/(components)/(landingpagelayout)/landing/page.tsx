                ...
                <header className="app-header">
                    <div className="main-header-container container-fluid">
                        <div className="header-content-left">
                            ...
                            <div className="header-element">
                                <Link aria-label="anchor" href="#!" scroll={false} className="sidemenu-toggle header-link" onClick={() => toggleNavigation()}>
                        ...
                        <div className="header-content-right">
                            <div className="header-element !items-center">
                                <div className="lg:hidden block">
                                    <Link href="/authentication/sign-up/signup-basic/" className="ti-btn ti-btn-primary !m-0 !me-2"> Sign Up </Link>
                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn m-0 p-2 px-3 ti-btn-success" data-hs-overlay="#hs-overlay-switcher"><i className="ri-settings-3-line animate-spin-slow"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="main-sidebar mx-0">
                            <nav className="main-menu-container nav nav-pills flex-column sub-open">
                                ...
                                <div className="lg:flex hidden space-x-2 rtl:space-x-reverse">
                                    <Link href="/authentication/sign-up/signup-basic/" className="ti-btn w-[6.375rem] ti-btn-primary-full m-0 p-2">Sign
                                        Up</Link>
                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn m-0 p-2 px-3 ti-btn-light !font-medium"
                                ...
                                <div className="xxl:col-span-3 xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                    <div className="box text-center team-card ">
                                        <div className="box-body p-[3rem]">
                                            ...
                                            <div className="mt-2">
                                                <Link href="/pages/profile/" className="ti-btn ti-btn-light !font-medium" target="_blank">View profile</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="container text-center">
                            ...
                            <div className="flex justify-center mb-6">
                                <nav className="bg-primary/10 p-4 rounded-md" aria-label="Tabs" role='tablist'>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary hs-tab-active:text-white text-primary py-2 px-4  text-sm font-medium text-center rounded-sm hover:text-primary active" id="pm-item" data-hs-tab="#pricing-monthly-pane" aria-controls="pricing-monthly-pane">
                                        Monthly
                                    </Link>
                                    <Link href="#!" scroll={false} className="hs-tab-active:bg-primary hs-tab-active:text-white text-primary py-2 px-4 text-sm font-medium text-center  rounded-sm hover:text-primary " id="py-item" data-hs-tab="#pricing-yearly-pane" aria-controls="pricing-yearly-pane">
                                        Yearly
                                    </Link>
                                </nav>
                            </div>
                        ...
                        <div className="container">
                            <div className="grid grid-cols-12 gap-6">
                                <div className="xl:col-span-4 col-span-12">
                                    <div className="px-6">
                                        <p className="font-semibold mb-4"><Link aria-label="anchor" href="/dashboards/crm/"><img src="../assets/images/brand-logos/desktop-dark.png" alt="" /></Link></p>
                                ...
                                <div className="xl:col-span-2 col-span-12">
                                    <div className="px-6">
                                        ...
                                        <ul className="list-unstyled opacity-[0.6] font-normal landing-footer-list">
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Email</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Profile</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Timeline</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Projects</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Contacts</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Portfolio</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="xl:col-span-2 col-span-12">
                                    <div className="px-6">
                                        ...
                                        <ul className="list-unstyled opacity-[0.6] font-normal landing-footer-list">
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Our Team</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Contact US</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">About</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Services</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Blog</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white">Terms &amp; Conditions</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="xl:col-span-4 col-span-12">
                                    <div className="px-6">
                                        ...
                                        <ul className="list-unstyled font-normal landing-footer-list">
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white opacity-[0.6]"><i className="ri-home-4-line me-1 align-middle"></i> New York, NY 10012, US</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white opacity-[0.6]"><i className="ri-mail-line me-1 align-middle"></i> info@fmail.com</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white opacity-[0.6]"><i className="ri-phone-line me-1 align-middle"></i> +(555)-1920 1831</Link>
                                            </li>
                                            <li>
                                                <Link href="#!" scroll={false} className="text-white opacity-[0.6]"><i className="ri-printer-line me-1 align-middle"></i> +(123) 1293 123</Link>
                                            </li>
