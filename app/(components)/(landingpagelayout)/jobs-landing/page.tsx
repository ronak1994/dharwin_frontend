                ...
                <header className="app-header">
                    ...
                    <div className="main-header-container container-fluid">
                        ...
                        <div className="header-content-left">
                            ...
                            <div className="header-element">
                                <Link aria-label="anchor" href="#!" scroll={false} className="sidemenu-toggle header-link">
                        ...
                        <div className="header-content-right">
                            <div className="header-element !items-center">
                                <div className="lg:hidden block">
                                    <Link href="/authentication/sign-up/signup-basic/" className="ti-btn ti-btn-primary me-2 !mb-0"> Sign Up </Link>
                                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn p-2 px-3 ti-btn-success !mb-0" data-hs-overlay="#hs-overlay-switcher"><i className="ri-settings-3-line animate-spin-slow"></i></Link>
                                </div>
                            </div>  </div>
                    </div>
                </header>
                        ...
                        <div className="main-sidebar mx-0">
                            <nav className="main-menu-container nav nav-pills sub-open">
                                ...
                                <ul className="main-menu">
                                    ...
                                    <li className="slide">
                                        <Link href="#blogs" className="side-menu__item">
                                ...
                                <div className="lg:flex hidden">
                                    <div className="btn-list lg:flex hidden lg:mt-2 xl:mt-0 mt-0">
                                        <Link href="/authentication/sign-up/signup-basic/" className="ti-btn bg-primary text-white font-![500] me-[0.365rem] whitespace-nowrap">
                                            Sign Up
                                        </Link>
                                        <Link href="/apps/jobs/job-post/" className="ti-btn  bg-secondary text-white !font-medium me-[0.365rem] whitespace-nowrap">
                                            Job Post
                                        </Link>
                                        <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn m-0 p-2 px-3 ti-btn-light"
                                        ...
                                        <div className="">
                                            ...
                                            <div className="mb-4 custom-form-group ">
                                                ...
                                                <div className="custom-form-btn">
                                                    <Link aria-label="anchor" href="#!" scroll={false} className="gps-location"><i className="ti ti-current-location"></i></Link>
                    ...
                    <section className="section section-bg dark:!bg-black/10 text-defaulttextcolor" id="jobs">
                        <div className="container">
                            <div className="flex items-center justify-between flex-wrap gap-4 mb-[3rem]">
                                ...
                                <div>
                                    <Link href="#!" scroll={false} className="ti-btn bg-primary text-white !font-medium">
                                        ...
                                        <div className="grid grid-cols-12 g-0">
                                            ...
                                            <div className="md:col-span-9 col-span-8 my-auto">
                                                <div className="box-body">
                                                    ...
                                                    <Link className="text-primary font-semibold" href="#!" scroll={false}>Explore Jobs<i className="ri-arrow-right-s-line align-middle rtl:rotate-180"></i></Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-span-12 md:col-span-4">
                                    <div className="box border dark:border-defaultborder/10">
                                        <div className="box-body rounded">
                                            <div className="mb-4 ms-1">
                                                <div className="icon-style">
                                                    <span className="avatar avatar-lg avatar-rounded bg-primary svg-white">
                                                        <i className="ti ti-file-invoice text-white"></i>
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <Link className="mx-1 text-primary font-semibold" href="#!" scroll={false}>Register Now<i className="ri-arrow-right-s-line align-middle rtl:rotate-180"></i></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="md:col-span-4 col-span-12">
                                    <div className="box border dark:border-defaultborder/10">
                                        <div className="box-body rounded">
                                            ...
                                            <Link className="mx-1 text-primary font-semibold" href="#!" scroll={false}>Complete Profile<i className="ri-arrow-right-s-line align-middle rtl:rotate-180"></i></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="md:col-span-4 col-span-12">
                                    <div className="box border dark:border-defaultborder/10">
                                        <div className="box-body rounded">
                                            ...
                                            <Link className="mx-1 text-primary font-semibold" href="#!" scroll={false}>Apply Now<i className="ri-arrow-right-s-line align-middle rtl:rotate-180"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="container">
                            <div className="grid grid-cols-12 gap-6 items-center justify-center">
                                ...
                                <div className="md:col-span-7 xl:col-span-8 col-span-12">
                                    <div className="my-6">
                                        <h2 className="font-semibold mb-4 text-[2rem]">Are You Looking For A Job? Just <Link href="#!" scroll={false} className="text-white text-decoration-line"> <u>drop</u> </Link> resume..</h2>
                                        ...
                                        <Link href="#!" scroll={false} className="ti-btn ti-btn-light ti-btn-lg dark:border-defaultborder/10 !font-medium"><i className="ti ti-upload"></i> Upload Your Resume</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section className="section text-defaulttextcolor text-defaultsize" id="features">
                        <div className="container">
                                    ...
                                    <div className="box featured-jobs">
                                        <div className="box-body">
                                            <div className="btn-list ltr:float-right rtl:float-left">
                                                <Link aria-label="anchor" href="#!" scroll={false} className="wishlist-icon me-[0.375rem] mb-[0.375rem]"
                                                ><span><i className="bi bi-heart"></i></span></Link>
                                                <Link aria-label="anchor" href="#!" scroll={false} className="wishlist-icon me-[0.375rem] mb-[0.375rem] !text-warning" ><span><i className="bi bi-star-fill"></i></span></Link>
                                            </div>
                                            <div className="sm:flex mb-4">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]"><Link href="#!" scroll={false}> HTML Developer - Fresher</Link></h5>
                                                    <Link href="#!" scroll={false}>Spotech Technical Solutions</Link>
                                                </div>
                                            </div>
                                            <div className="popular-tags mb-4">
                                                <Link href="#!" scroll={false} className="badge rounded-pill bg-light me-1 text-default"><i className="bi bi-geo-alt text-[#8c9097] dark:text-white/50 me-1"></i> Hyderabad</Link>
                                                <Link href="#!" scroll={false} className="badge rounded-pill bg-light me-1 text-default"><i className="bi bi-briefcase text-[#8c9097] dark:text-white/50 me-1"></i> 13 Openings</Link>
                                                <Link href="#!" scroll={false} className="badge rounded-pill bg-light me-1 text-default"><i className="bi bi-mortarboard text-[#8c9097] dark:text-white/50 me-1"></i> Graduate</Link>
                                                <Link href="#!" scroll={false} className="badge rounded-pill bg-light me-1 text-default"><i className="bi bi-clock text-[#8c9097] dark:text-white/50 me-1"></i> Min - 2Years</Link>
                                                <Link href="#!" scroll={false} className="badge rounded-pill bg-light me-1 text-default"><i className="bi bi-moon-stars text-[#8c9097] dark:text-white/50 me-1"></i> flexible-shift</Link>
                                            </div>
                                            <div className="flex justify-between">
                                                <h6 className="font-semibold mb-0 text-default text-[1rem]">$25,000 - $35,000</h6>
                                                <Link href="#!" scroll={false} className="text-primary font-semibold text-[0.875rem]">
                                    ...
                                    <div className="box featured-jobs">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-4">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]"><Link href="#!" scroll={false}> React Lead Developer</Link></h5>
                                    ...
                                    <div className="box featured-jobs">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-4">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]"><Link href="#!" scroll={false}> Vuejs Frontend Developer</Link></h5>
                                    ...
                                    <div className="box featured-jobs">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-4">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]"><Link href="#!" scroll={false}> Wordpress Developer - Remote</Link></h5>
                            ...
                            <div className="text-center">
                                <Link href="#!" scroll={false} className="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">
                            ...
                            <div className="grid grid-cols-12 gap-6">
                                <div className="lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                                    <div className="box feature-style">
                                        <div className="box-body">
                                            <Link aria-label="anchor" href="#!" scroll={false} className="stretched-link"></Link>
                        ...
                        <div className="container">
                            <div className="grid grid-cols-12 items-center justify-center">
                                ...
                                <div className="md:col-span-8 col-span-12 my-6">
                                    <h2 className="font-semibold mb-4 text-[2rem] dark:text-defaulttextcolor/70">Are You Looking For A best Candidate? <br /> Just <Link href="#!" scroll={false} className="text-primary text-decoration-line"> <u>Publish</u> </Link> your job here..</h2>
                                    ...
                                    <Link href="#!" scroll={false} className="ti-btn bg-primary text-white dark:border-defaultborder/10 !font-medium ti-btn-lg"><i className="ti ti-upload"></i> Publish new job</Link>
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <div className="md:col-span-1 col-span-12">
                                    <div className="box border dark:border-defaultborder/10">
                                        ...
                                        <div className="box-body">
                                            ...
                                            <Link className="text-primary font-semibold" href="#!" scroll={false}>Read this post<i className="ri-arrow-right-s-line align-middle rtl:rotate-180"></i></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="md:col-span-1 col-span-12">
                        ...
                        <div className="container">
                            <div className="grid grid-cols-12 gap-6">
                                ...
                                <div className="lg:col-span-3 col-span-12 text-end my-auto">
                                    <Link href="#!" scroll={false} className="ti-btn ti-btn-lg ti-btn-danger-full ti-btn-wave">Upload Your Resume</Link>
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div className="grid grid-cols-12 gap-x-6 justify-center">
                                <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-3 md:col-span-6 sm:col-span-6 col-span-12">
                                    <div className="box text-start featured-card-4">
                                        <Link aria-label="anchor" href="#!" scroll={false} className="open-link"></Link>
                                        ...
                                        <div className="box-body">
                                            <div className="flex items-center mb-4">
                                                ...
                                                <div className='text-start'>
                                                    ...
                                                    <p className="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CEO OF NORJA</p>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                        ...
                                        <div className="box-body">
                                            <div className="flex items-center mb-4">
                                                ...
                                                <div className='text-start'>
                                                    ...
                                                    <p className="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">MANAGER CHO</p>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                <span className="text-[#8c9097] dark:text-white/50">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                                        ...
                                        <div className="box-body">
                                            <div className="flex items-center mb-4">
                                                ...
                                                <div className='text-start'>
                                                    ...
                                                    <p className="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CEO OF EMPIRO</p>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                <span className="text-[#8c9097] dark:text-white/50">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                                        ...
                                        <div className="box-body">
                                            <div className="flex items-center mb-4">
                                                ...
                                                <div className='text-start'>
                                                    ...
                                                    <p className="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CHIEF SECRETARY MBIO</p>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                <span className="text-[#8c9097] dark:text-white/50">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                                        ...
                                        <div className="box-body">
                                            <div className="flex items-center mb-4">
                                                ...
                                                <div className='text-start'> 
                                                    ...
                                                    <p className="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CEO ARMEDILLO</p>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                <span className="text-[#8c9097] dark:text-white/50">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                                        ...
                                        <div className="box-body">
                                            <div className="flex items-center mb-4">
                                                ...
                                                <div className='text-start'>
                                                    ...
                                                    <p className="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">AGGENT AMIO</p>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                <span className="text-[#8c9097] dark:text-white/50">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                                        ...
                                        <div className="box-body">
                                            <div className="flex items-center mb-4">
                                                ...
                                                <div className='text-start'>
                                                    ...
                                                    <p className="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CEO MR BRAND</p>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                <span className="text-[#8c9097] dark:text-white/50">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                                        ...
                                        <div className="box-body">
                                            <div className="flex items-center mb-4">
                                                ...
                                                <div className='text-start'>
                                                    ...
                                                    <p className="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CEO AIBMO</p>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                <span className="text-[#8c9097] dark:text-white/50">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                                        ...
                                        <div className="box-body">
                                            <div className="flex items-center mb-4">
                                                ...
                                                <div className='text-start'>
                                                    ...
                                                    <p className="text-[0.625rem] mb-0 font-semibold text-[#8c9097] dark:text-white/50">CHIEF SECRETARY BHOL</p>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                <span className="text-[#8c9097] dark:text-white/50">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                    ...
                    <section className="section bg-banner" id="career-advice">
                        <div className="grid grid-cols-12 justify-center !px-4">
                            ...
                            <div className="lg:col-span-6 col-span-12 text-center">
                                ...
                                <Link href="#!" scroll={false} className="ti-btn ti-btn-lg ti-btn-light me-2 dark:border-defaultborder/10 !font-medium"><i className="bi bi-search me-1"></i> Search Jobs</Link>
                                <Link href="#!" scroll={false} className="ti-btn ti-btn-lg  ti-btn-danger-full text-white  !font-medium"><i className="bi bi-send me-1"></i> Apply Job Now</Link>
                            </div>
                            <div className="lg:col-span-3 col-span-12"></div>
                        </div>
                    </section>
                                ...
                                <div>
                                    <ul className="list-none font-normal landing-footer-list mb-0 flex gap-2 flex-wrap">
                                        <li className="!mb-0 px-3">
                                            <Link href="#!" scroll={false} className="text-white opacity-[0.8]">Terms Of Service</Link>
                                        </li>
                                        <li className="!mb-0 px-3">
                                            <Link href="#!" scroll={false} className="text-white opacity-[0.8]">Privacy Policy</Link>
                                        </li>
                                        <li className="!mb-0 px-3">
                                            <Link href="#!" scroll={false} className="text-white opacity-[0.8]">Legal</Link>
                                        </li>
                                        <li className="!mb-0 px-3">
                                            <Link href="#!" scroll={false} className="text-white opacity-[0.8]">Contact</Link>
                                        </li>
                                        <li className="!mb-0 px-3">
                                            <Link href="#!" scroll={false} className="text-white opacity-[0.8]">Report Abuse</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
