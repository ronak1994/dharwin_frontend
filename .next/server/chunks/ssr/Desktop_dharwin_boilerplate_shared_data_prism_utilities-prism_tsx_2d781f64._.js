module.exports=[86367,a=>{"use strict";let b=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
{AvatarOffline.map((idx) => 
    (<span className={&#96;avatar avatar-&#36;{idx.class} 
        ...
        <img src={idx.src} alt="img" /></span>))}
</div>`,o=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="box-body">
...
// End Prism Code//`;a.s(["avatar1",0,j,"avatar10",0,s,"avatar11",0,t,"avatar12",0,u,"avatar13",0,v,"avatar14",0,w,"avatar15",0,x,"avatar16",0,y,"avatar17",0,z,"avatar18",0,A,"avatar19",0,B,"avatar2",0,k,"avatar20",0,C,"avatar21",0,D,"avatar22",0,E,"avatar3",0,l,"avatar4",0,m,"avatar5",0,n,"avatar6",0,o,"avatar7",0,p,"avatar8",0,q,"avatar9",0,r,"border1",0,b,"border2",0,c,"border3",0,d,"border4",0,e,"border5",0,f,"border6",0,g,"border7",0,h,"border8",0,i])}];

//# sourceMappingURL=Desktop_dharwin_boilerplate_shared_data_prism_utilities-prism_tsx_2d781f64._.js.map