module.exports=[357626,a=>{"use strict";let b=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
<div className="flex">
    ...
    <div className="flex-1 md:flex md:justify-between ms-2">
        ...
        <p className="text-sm mt-3 md:mt-0 md:ms-6">
            <a className="dark:text-defaulttextcolor/70 hover:text-gray-500 font-medium whitespace-nowrap"
                href="#!" scroll={false}>Details</a>
        </p>
    </div>
</div>
</div>
...
<div className="bg-success/20 border-t-2 border-success rounded-lg p-4 dark:bg-success/20" role="alert">
    <div className="flex">
      <div className="flex-shrink-0">
        <span className="inline-flex justify-center items-center size-8 rounded-full border-1 border-success bg-success/50 text-teal-800 dark:border-teal-900 dark:bg-teal-800 dark:text-teal-400">
          <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="m9 12 2 2 4-4"/></svg>
        </span>
      </div>
      <div className="ms-3">
  ...
  <div className="bg-danger/20 border-s-4 border-danger p-4 dark:bg-danger/20" role="alert">
    <div className="flex">
      <div className="flex-shrink-0">
        <span className="inline-flex justify-center items-center size-8 rounded-full border-1 border-danger bg-danger/40 text-red-800 dark:border-danger dark:bg-danger/20 dark:text-red-400">
          <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
        </span>
      </div>
      <div className="ms-3">
        <h6 className="text-gray-800 font-semibold dark:text-white">
...
<div className="bg-warning/10 border border-warning text-sm text-warning/80 rounded-lg p-4" role="alert">
    <div className="flex">
      <div className="flex-shrink-0">
...
<div className="bg-info/10 border border-info text-sm text-info/80 rounded-lg p-4" role="alert">
    <div className="flex">
      <div className="flex-shrink-0">
        <svg className="flex-shrink-0 size-4 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>
      </div>
...
// End Prism Code//`,g=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <div className="bg-info/10 border border-info/20 text-info/80 rounded-lg p-4 " role="alert">
<div className="flex">
  <div className="flex-shrink-0">
    <svg className="flex-shrink-0 size-4 mt-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
  </div>
  <div className="ms-3">
...
<div className="flex">
  <div className="flex-shrink-0">
    <svg className="flex-shrink-0 size-4 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
  </div>
  <div className="flex-1 md:flex md:justify-between ms-2">
    <p className="text-sm">
      A new software update is available. See what's new in version 3.0.7
    ...
    <p className="text-sm mt-3 md:mt-0 md:ms-6">
      <a className="text-gray-800 hover:text-gray-500 font-medium whitespace-nowrap dark:text-gray-200 dark:hover:text-gray-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Details</a>
    </p>
  </div>
</div>
</div>
// End Prism Code//`,i=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-4 dark:bg-bodybg dark:border-white/10" role="alert">
<div className="flex">
  <div className="flex-shrink-0">
    <svg className="flex-shrink-0 size-4 text-blue-600 mt-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
  </div>
  <div className="ms-3">
    <h6 className="text-gray-800 font-semibold dark:text-white">
...
// End Prism Code//`,j=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 {defaultalerts.map((idx) =>(&lt;div className={a&#768;alert alert-&#36;{idx.color}a&#769;} role="alert" key={Math.random()}>
...
(<div className={a&#768;alert alert-&#36;{idx.color}a&#769;} role="alert" key={Math.random()}>{a&#768;A simple &#36;{idx.text} alert witha&#769;} 
...
<div className="alert alert-img alert-primary alert-dismissible fase show flex-wrap relative" role="alert" id="dismiss-alert51">
...
// End Prism Code//`,G=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <span
className="max-w-40 truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-lg text-xs font-medium bg-primary/10 text-primary/80">This
content is a little bit longer.</span>
<span
className="max-w-40 truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-lg text-xs font-medium bg-secondary/10 text-secondary/80">This
content is a little bit longer.</span>
<span
className="max-w-40 truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-lg text-xs font-medium bg-success/10 text-success/80">This
content is a little bit longer.</span>
<span
className="max-w-40 truncate whitespace-nowrap inline-block py-1.5 px-3 rounded-lg text-xs font-medium bg-danger/10 text-danger/80">This
content is a little bit longer.</span>
// End Prism Code//`,H=`//<!-- Prism Code: This code is only used for showcode purpose -->//
  <span
className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-primary/10 text-primary">
<span className="size-1.5 inline-block rounded-full bg-primary/80"></span>
Badge
</span>
<span
className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-secondary/10 text-secondary">
<span className="size-1.5 inline-block rounded-full bg-secondary/80"></span>
Badge
</span>
<span
className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-warning/10 text-warning">
<span className="size-1.5 inline-block rounded-full bg-warning/80"></span>
Badge
</span>
<span
className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-success/10 text-success">
<span className="size-1.5 inline-block rounded-full bg-success/80"></span>
Badge
</span>
<span
className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-info/10 text-info">
<span className="size-1.5 inline-block rounded-full bg-info/80"></span>
Badge
</span>
<span
className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-danger/10 text-danger">
<span className="size-1.5 inline-block rounded-full bg-danger/80"></span>
Badge
</span>
// End Prism Code//`,I=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <span
className="py-1 px-2 inline-flex items-center gap-x-1 text-xs font-medium bg-primary/10 text-primary/80 rounded-full">
...
<span
className="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-secondary/10 text-secondary/80 rounded-full">
<svg className="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="24"
    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path
...
<span
className="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-warning/10 text-warning/80 rounded-full">
<svg className="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="24"
    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<span
className="py-1 px-2 inline-flex items-center gap-x-1 text-xs bg-info/10 text-info/80 rounded-full">
<svg className="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="24"
    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<span
className="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-success/10 text-success/80 rounded-full">
<svg className="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="24"
    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<span
className="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-danger/10 text-danger/80 rounded-full">
<svg className="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="24"
    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<span
className="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs bg-primary/10 text-primary/80 rounded-full">
<svg className="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="24"
    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="22 7 13.5 15.5 8.5 10.5 2 17" />
...
<span
className="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs bg-secondary/10 text-secondary/80 rounded-full">
<svg className="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="24"
    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="22 17 13.5 8.5 8.5 13.5 2 7" />
...
// End Prism Code//`,J=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<span
className="inline-flex items-center gap-x-1.5 py-1.5 ps-3 pe-2 rounded-full text-xs font-medium bg-primary/10 text-primary/80">
Badge
<button type="button"
...
<span
className="inline-flex items-center gap-x-1.5 py-1.5 ps-3 pe-2 rounded-full text-xs font-medium bg-secondary/10 text-secondary/80">
Badge
<button type="button"
...
<span
className="inline-flex items-center gap-x-1.5 py-1.5 ps-3 pe-2 rounded-full text-xs font-medium bg-success/10 text-success/80">
Badge
<button type="button"
...
<span
className="inline-flex items-center gap-x-1.5 py-1.5 ps-3 pe-2 rounded-full text-xs font-medium bg-warning/10 text-warning/80">
Badge
<button type="button"
...
<span
className="inline-flex items-center gap-x-1.5 py-1.5 ps-3 pe-2 rounded-full text-xs font-medium bg-info/10 text-info/80">
Badge
<button type="button"
...
<span
className="inline-flex items-center gap-x-1.5 py-1.5 ps-3 pe-2 rounded-full text-xs font-medium bg-danger/10 text-danger/80">
Badge
<button type="button"
...
// End Prism Code//`,K=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <div
className="inline-flex flex-nowrap items-center border border-defaultborder rounded-full p-1.5 pe-3 dark:border-white/10">
...
<div
className="inline-flex flex-nowrap items-center border border-defaultborder rounded-full p-1.5 dark:border-white/10">
<img className="me-1.5 mb-0 inline-block avatar avatar-xs avatar-rounded"
...
// End Prism Code//`,_=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list space-x-2
 rtl:space-x-reverse">
...
// End Prism Code//`,aa=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,ab=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,ac=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,ad=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list space-x-2 rtl:space-x-reverse">
<button type="button" aria-label="button" 
...
// End Prism Code//`,ae=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,af=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list space-x-2 rtl:space-x-reverse">
...
// End Prism Code//`,ag=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list flex">
...
// End Prism Code//`,ah=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list space-x-2 rtl:space-x-reverse">
...
// End Prism Code//`,ai=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list space-x-2 rtl:space-x-reverse">
...
// End Prism Code//`,ak=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list space-x-2 rtl:space-x-reverse">
...
// End Prism Code//`,al=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,am=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-group" role="group" aria-label="Basic mixed styles example">
...
// End Prism Code//`,an=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,ao=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,ap=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,aq=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
<p className="box-title mb-4 !text-[0.813rem] 
...
// End Prism Code//`,as=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<p className="box-title mb-4 !text-[0.813rem]
...
// End Prism Code//`,at=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<p className="box-title mb-4 !text-[0.813rem] 
...
// End Prism Code//`,au=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<img className="!rounded-md float-start" 
src="../../assets/images/media/media-53.jpg" alt="..." />
// End Prism Code//`,av=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<img className="!rounded-md mx-auto block" 
src="../../assets/images/media/media-55.jpg" alt="..." />
// End Prism Code//`,aw=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<img className="!rounded-md ltr:float-right
 rtl:float-left" src="../../assets/images/media/media-54.jpg" alt="..." />
// End Prism Code//`,ax=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,ay=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,az=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,aA=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<p className="mb-3">Use <code>ti-img-thumbnail-rounded</code>
...
// End Prism Code//`,aB=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <ul className="ti-list-group">{ActiveButtons.map((idx) =>
...
<li className="ti-list-group-item">
<input className="form-check-input me-1 font-semibold" type="checkbox" value="" aria-label="..." /> To have a complete 360\xb0 overview of sales information, having.</li>
</ul>
// End Prism Code//`,aN=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
<li className="ti-list-group-item">
 <input className="form-check-input me-1" type="radio" value=""  name="list-radio" />To have a complete 360\xb0 overview of sales information, having.</li>
</ul>
// End Prism Code//`,aO=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<ul className="ti-list-group">
...
<ul className="ti-pagination  mb-0">
    <li className="page-item disabled"><a className="page-link px-3 py-[0.375rem]"
            href="#!" scroll={false}>Previous</a></li>
    <li className="page-item"><a className="page-link px-3 py-[0.375rem]"
            href="#!" scroll={false}>1</a></li>
    <li className="page-item"><a className="page-link px-3 py-[0.375rem]"
            href="#!" scroll={false}>2</a></li>
    <li className="page-item"><a className="page-link px-3 py-[0.375rem]"
            href="#!" scroll={false}>Next</a></li>
</ul>
</nav>
// End Prism Code//`,aQ=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<nav aria-label="Page navigation">
<ul className="ti-pagination mb-0">
    <li className="page-item">
        <a className="page-link px-3 py-[0.375rem]" href="#!"
            aria-label="Previous">
...
<ul className="ti-pagination justify-center">
    ...
    <li className="page-item"><a className="page-link px-3 py-[0.375rem]"
            href="#!" scroll={false}>3</a></li>
    <li className="page-item">
        <a className="page-link px-3 py-[0.375rem]" href="#!" scroll={false}>Next</a>
    </li>
</ul>
</nav>
<nav aria-label="Page navigation">
...
<ul className="ti-pagination">
    ...
    <li className="page-item"><a className="page-link px-3 py-[0.375rem]"
            href="#!" scroll={false}>1</a></li>
    <li className="page-item " aria-current="page">
        <a className="page-link active px-3 py-[0.375rem]"
            href="#!" scroll={false}>2</a>
    </li>
    <li className="page-item">
        <a className="page-link px-3 py-[0.375rem]" href="#!" scroll={false}>Next</a>
    </li>
...
<ul className="ti-pagination mb-0">
    <li className="page-item disabled rtl:rotate-180">
        <a aria-label="anchor" className="page-link" href="#!" scroll={false}>
            <i className="ri-arrow-left-s-line align-middle"></i>
        </a>
    </li>
    <li className="page-item"><a className="page-link" href="#!" scroll={false}>1</a></li>
    ...
    <li className="page-item"><a className="page-link" href="#!" scroll={false}>21</a>
    </li>
...
<ul className="ti-pagination mb-0 flex-wrap">
    <li className="page-item disabled">
        <a className="page-link px-3 py-[0.375rem] !border-0"
            href="#!" scroll={false}>
            Prev
        </a>
    </li>
    <li className="page-item active"><a className="page-link px-3 py-[0.375rem] !border-0"
            href="#!" scroll={false}>1</a></li>
    <li className="page-item"><a className="page-link px-3 py-[0.375rem] !border-0"
            href="#!" scroll={false}>2</a></li>
    <li className="page-item">
        <a aria-label="anchor" className="page-link px-3 py-[0.375rem] !border-0"
            href="#!" scroll={false}>
            <i className="bi bi-three-dots"></i>
        </a>
    </li>
    <li className="page-item"><a className="page-link px-3 py-[0.375rem] !border-0"
            href="#!" scroll={false}>17</a></li>
    <li className="page-item">
        <a className="page-link px-3 py-[0.375rem] !text-primary !border-0"
            href="#!" scroll={false}>
            next
        </a>
    </li>
...
<ul className="ti-pagination mb-0 flex-wrap">
    <li className="page-item disabled">
        <a className="page-link" href="#!" scroll={false}>
            Prev
        </a>
    </li>
    <li className="page-item "><a className="page-link active"
            href="#!" scroll={false}>1</a></li>
    <li className="page-item"><a className="page-link" href="#!" scroll={false}>2</a></li>
    <li className="page-item">
        <a aria-label="anchor" className="page-link" href="#!" scroll={false}>
            <i className="bi bi-three-dots"></i>
        </a>
    </li>
    <li className="page-item"><a className="page-link" href="#!" scroll={false}>16</a>
    </li>
    <li className="page-item">
        <a className="page-link !text-primary" href="#!" scroll={false}>
            next
        </a>
    </li>
</ul>
...
// End Prism Code//`,a_=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,a0=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <div
...
<nav className="flex items-center gap-x-1">
    <button type="button"
        className="min-h-[46px] min-w-[46px] py-2 px-2.5 inline-flex jusify-center items-center gap-x-2 text-sm rounded-md text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-white/10 dark:focus:bg-white/10">
        <i className="ri-arrow-left-s-line align-middle rtl:rotate-180"></i>
        <span aria-hidden="true" className="sr-only">Previous</span>
    </button>
    <div className="flex items-center gap-x-1">
...
// End Prism Code//`,a1=`//<!-- Prism Code: This code is only used for showcode purpose -->//
  <div
className="grid justify-center sm:flex sm:justify-start sm:items-center gap-2 flex-wrap">
...
<nav className="flex items-center gap-x-1">
    <button type="button"
        className="min-h-[46px] min-w-[46px] py-2 px-2.5 inline-flex jusify-center items-center gap-x-2 text-sm rounded-full text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-white/10 dark:focus:bg-white/10">
        <i className="ri-arrow-left-s-line align-middle rtl:rotate-180"></i>
        <span aria-hidden="true" className="sr-only">Previous</span>
    </button>
    <div className="flex items-center gap-x-1">
...
// End Prism Code//`,a2=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="grid justify-center sm:flex sm:justify-start sm:items-center gap-2 flex-wrap">
...
// End Prism Code//`,a3=`//<!-- Prism Code: This code is only used for showcode purpose -->//
  <div
className="grid justify-center sm:flex sm:justify-start sm:items-center gap-2 flex-wrap">
...
// End Prism Code//`,a4=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div
className="grid justify-center sm:flex sm:justify-start sm:items-center gap-2 flex-wrap">
...
// End Prism Code//`,a5=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div
className="grid justify-center sm:flex sm:justify-start sm:items-center gap-2 flex-wrap">
...
// End Prism Code//`,a6=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,a7=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,a8=`//<!-- Prism Code: This code is only used for showcode purpose -->//
{stripped.map((idx)=>(
...
// End Prism Code//`,a9=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,ba=`//<!-- Prism Code: This code is only used for showcode purpose -->//
{lables.map((idx)=>(
...
// End Prism Code//`,bb=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bc=`//<!-- Prism Code: This code is only used for showcode purpose -->//
{animated.map((idx)=>(
...
// End Prism Code//`,bd=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <div className="">
...
// End Prism Code//`,be=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bf=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bg=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
<div className="relative size-40">
    <svg className="size-full" width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="origin-center -rotate-90 transform">
            <circle cx="18" cy="18" r="16" fill="none" className="stroke-current text-primary" strokeWidth="2" stroke-dasharray="100" stroke-dashoffset="75"></circle>
        </g>
    </svg>
</div>
<div className="relative size-40">
...
// End Prism Code//`,bh=`//<!-- Prism Code: This code is only used for showcode purpose -->//
{animated.map((idx)=>(
    <div className="progress mb-4" aria-valuenow={idx.valuenow} 
aria-valuemin="0" aria-valuemax="100" key={Math.random()}>
    <div className={a&#768;progress-bar &#36;{idx.class}a&#769;}>
...
// End Prism Code//`,bi=`//<!-- Prism Code: This code is only used for showcode purpose -->//
{Gradient.map((idx)=>(
    <div className="progress mb-4" aria-valuenow={idx.valuenow} 
    aria-valuemin="0" aria-valuemax="100" key={Math.random()}>
...
// End Prism Code//`,bj=`//<!-- Prism Code: This code is only used for showcode purpose -->//
{Gradient.map((idx)=>(
...
// End Prism Code//`,bk=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bl=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bm=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bn=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 {Custom.map((idx) => (
...
// End Prism Code//`,bo=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bp=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-spinner" role="status">
<span className="sr-only">Loading...</span>
</div>
// End Prism Code//`,bq=`//<!-- Prism Code: This code is only used for showcode purpose -->//
{Colorspinner.map((idx) =>(
     <div className={a&#768;ti-spinner text-&#36;{idx.color}a&#769;} role="status" key={Math.random()}>
     <span className="sr-only">Loading...</span>
     </div>
     ))}
// End Prism Code//`,br=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bs=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bt=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bu=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bv=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="text-center">
<div className="ti-spinner" role="status">
<span className="sr-only">Loading...</span>
</div>
</div>
// End Prism Code//`,bw=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-spinner m-[3rem]" role="status">
<span className="sr-only">Loading...</span>
</div>
// End Prism Code//`,bx=`//<!-- Prism Code: This code is only used for showcode purpose -->//
   <div className="box-body ">
...
// End Prism Code//`,by=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,bz=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,b_=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <div className="ti-btn-list">
...
// End Prism Code//`,b0=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <div className="ti-btn-list">
<div className="ti-dropdown hs-dropdown"> 
...
// End Prism Code//`,b1=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,b2=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,b3=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <div className="bd-example">
    <ul className="dropdown-menu border dark:border-defaultborder/10 shadow-sm">
...
// End Prism Code//`,b4=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="bd-example">
...
// End Prism Code//`,cg=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="box-body object-fit-container">
    <video src="../../assets/video/1.mp4" className="object-cover
    !rounded-md border dark:border-defaultborder/10" autoPlay loop muted>
    </video>
</div>
// End Prism Code//`,ch=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="box-body object-fit-container">
...
// End Prism Code//`,ci=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="box-body object-fit-container">
    <video src="../../assets/video/1.mp4" className="object-scale-down 
    !rounded-md border dark:border-defaultborder/10" autoPlay loop muted>
    </video>
</div>
// End Prism Code//`,cj=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="box-body object-fit-container">
    <video src="../../assets/video/1.mp4" className="object-none 
    !rounded-md border dark:border-defaultborder/10" autoPlay loop muted>
    </video>
</div>
// End Prism Code//`,ck=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list">
...
// End Prism Code//`,cl=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list">
...
// End Prism Code//`,cm=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="ti-btn-list">
<div className="hs-tooltip ti-main-tooltip  [--trigger:click] [--placement:top]">
...
// End Prism Code//`,cn=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <div className="ti-btn-list">
<div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top] ">
...
// End Prism Code//`,co=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="hs-tooltip ti-main-tooltip
...
// End Prism Code//`,cp=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,cq=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,cs=`//<!-- Prism Code: This code is only used for showcode purpose -->//
   <div className="flex justify-center">
  <div className="hs-tooltip ti-main-tooltip [--trigger:click]">
    <a className="hs-tooltip-toggle ti-main-tooltip-toggle" href="javascript:;">
      <span className="w-10 h-10 ti-btn p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bodybg dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
...
// End Prism Code//`,ct=`//<!-- Prism Code: This code is only used for showcode purpose -->//
    <div className="hs-tooltip ti-main-tooltip [--trigger:click]">
...
// End Prism Code//`,cu=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="flex justify-center">
...
// End Prism Code//`,cv=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,cw=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
// End Prism Code//`,cx=`//<!-- Prism Code: This code is only used for showcode purpose -->//
  <blockquote className="relative">
<svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
    width="16" height="16" viewBox="0 0 16 16" fill="none"
    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
// End Prism Code//`,cy=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<blockquote className="relative">
<svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
    width="16" height="16" viewBox="0 0 16 16" fill="none"
    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
// End Prism Code//`,cz=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <blockquote className="relative">
<svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
    width="16" height="16" viewBox="0 0 16 16" fill="none"
    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
<li className="text-sm">
  <Link className="flex items-center text-primary hover:text-primary dark:text-primary" href="#!" scroll={false}>
    Home
...
<li className="text-sm">
  <Link className="flex items-center text-gray-500 dark:text-[#8c9097] dark:text-white/50 hover:text-primary" href="#!" scroll={false}>
    Library
  </Link>
</li>
</ol>
...
// End Prism Code//`;a.s(["Actionsalert",0,g,"Additionalalerts",0,x,"Basicalert",0,b,"Borderedalert",0,d,"Customizedalerts",0,u,"Default",0,c,"Defaultalerts",0,j,"Defaultshadowsalerts",0,o,"Discoveryalert",0,i,"Iconalerts",0,t,"Imagesalerts",0,v,"Imagesize",0,w,"Linkalerts",0,k,"Outlinealerts",0,m,"Roundedcustomalerts",0,s,"Roundeddefaultsalerts",0,r,"Roundedoutlinesalerts",0,q,"Roundedsalerts",0,p,"Solidalerts",0,l,"Solidshadowalerts",0,n,"badges1",0,y,"badges10",0,H,"badges11",0,I,"badges12",0,J,"badges13",0,K,"badges14",0,L,"badges15",0,M,"badges16",0,N,"badges17",0,O,"badges18",0,P,"badges19",0,Q,"badges2",0,z,"badges3",0,A,"badges4",0,B,"badges5",0,C,"badges6",0,D,"badges7",0,E,"badges8",0,F,"badges9",0,G,"blackquote1",0,cw,"blackquote2",0,cx,"blackquote3",0,cy,"blackquote4",0,cz,"blackquote5",0,cA,"blackquote6",0,cB,"blackquote7",0,cC,"blackquote8",0,cD,"blackquote9",0,cE,"breadcrumb1",0,cN,"breadcrumb2",0,cO,"breadcrumb3",0,cP,"breadcrumb4",0,cQ,"breadcrumb5",0,cR,"buttons1",0,R,"buttons10",0,$,"buttons11",0,_,"buttons12",0,aa,"buttons13",0,ab,"buttons14",0,ac,"buttons15",0,ad,"buttons16",0,ae,"buttons17",0,af,"buttons18",0,ag,"buttons19",0,ah,"buttons2",0,S,"buttons20",0,ai,"buttons21",0,aj,"buttons22",0,ak,"buttons3",0,T,"buttons4",0,U,"buttons5",0,V,"buttons6",0,W,"buttons7",0,X,"buttons8",0,Y,"buttons9",0,Z,"descriptionalert",0,e,"dropdown1",0,bL,"dropdown10",0,bU,"dropdown11",0,bV,"dropdown12",0,bW,"dropdown13",0,bX,"dropdown14",0,bY,"dropdown15",0,bZ,"dropdown16",0,b$,"dropdown17",0,b_,"dropdown18",0,b0,"dropdown19",0,b1,"dropdown2",0,bM,"dropdown20",0,b2,"dropdown21",0,b3,"dropdown22",0,b4,"dropdown3",0,bN,"dropdown4",0,bO,"dropdown5",0,bP,"dropdown6",0,bQ,"dropdown7",0,bR,"dropdown8",0,bS,"dropdown9",0,bT,"group1",0,al,"group2",0,am,"group3",0,an,"group4",0,ao,"group5",0,ap,"group6",0,aq,"image1",0,ar,"image2",0,as,"image3",0,at,"image4",0,au,"image5",0,av,"image6",0,aw,"image7",0,ax,"image8",0,ay,"image9",0,az,"list1",0,aA,"list10",0,aJ,"list11",0,aK,"list12",0,aL,"list13",0,aM,"list14",0,aN,"list15",0,aO,"list2",0,aB,"list3",0,aC,"list4",0,aD,"list5",0,aE,"list6",0,aF,"list7",0,aG,"list8",0,aH,"list9",0,aI,"listalert",0,f,"object1",0,b5,"object10",0,ce,"object11",0,cf,"object12",0,cg,"object13",0,ch,"object14",0,ci,"object15",0,cj,"object2",0,b6,"object3",0,b7,"object4",0,b8,"object5",0,b9,"object6",0,ca,"object7",0,cb,"object8",0,cc,"object9",0,cd,"page1",0,aP,"page10",0,aY,"page11",0,aZ,"page12",0,a$,"page13",0,a_,"page14",0,a0,"page15",0,a1,"page16",0,a2,"page17",0,a3,"page18",0,a4,"page19",0,a5,"page2",0,aQ,"page3",0,aR,"page4",0,aS,"page5",0,aT,"page6",0,aU,"page7",0,aV,"page8",0,aW,"page9",0,aX,"popover1",0,ck,"popover10",0,ct,"popover11",0,cu,"popover12",0,cv,"popover2",0,cl,"popover3",0,cm,"popover4",0,cn,"popover5",0,co,"popover6",0,cp,"popover7",0,cq,"popover8",0,cr,"popover9",0,cs,"progress1",0,a6,"progress10",0,bf,"progress11",0,bg,"progress12",0,bh,"progress13",0,bi,"progress14",0,bj,"progress15",0,bk,"progress16",0,bl,"progress17",0,bm,"progress18",0,bn,"progress19",0,bo,"progress2",0,a7,"progress3",0,a8,"progress4",0,a9,"progress5",0,ba,"progress6",0,bb,"progress7",0,bc,"progress8",0,bd,"progress9",0,be,"rightalert",0,h,"spinner1",0,bp,"spinner10",0,by,"spinner2",0,bq,"spinner3",0,br,"spinner4",0,bs,"spinner5",0,bt,"spinner6",0,bu,"spinner7",0,bv,"spinner8",0,bw,"spinner9",0,bx,"toast1",0,bz,"toast2",0,bA,"toast3",0,bB,"toast4",0,bC,"toast5",0,bD,"toast6",0,bE,"tooltip1",0,bF,"tooltip2",0,bG,"tooltip3",0,bH,"tooltip4",0,bI,"tooltip5",0,bJ,"tooltip6",0,bK,"typography1",0,cF,"typography2",0,cG,"typography3",0,cH,"typography4",0,cI,"typography5",0,cJ,"typography6",0,cK,"typography7",0,cL,"typography8",0,cM])}];

//# sourceMappingURL=Desktop_dharwin_boilerplate_shared_data_prism_uielementsprism_tsx_54817d0f._.js.map