(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,691665,a=>{"use strict";var e=a.i(616309),s=a.i(639146);a.s(["default",0,({title:a})=>((0,s.useEffect)(()=>{document.title=`Dharwin Business Solutions - ${a}`},[]),(0,e.jsx)(e.Fragment,{}))])},193358,a=>{"use strict";var e=a.i(616309),s=a.i(639146);a.s(["default",0,a=>(0,e.jsx)(s.Fragment,{children:(0,e.jsxs)("div",{className:"block justify-between page-header md:flex",children:[(0,e.jsx)("div",{children:(0,e.jsx)("h3",{className:"!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold",children:a.currentpage})}),(0,e.jsxs)("ol",{className:"flex items-center whitespace-nowrap min-w-0",children:[(0,e.jsx)("li",{className:"text-[0.813rem] ps-[0.5rem]",children:(0,e.jsxs)("a",{className:"flex items-center text-primary hover:text-primary dark:text-primary truncate",href:"#!",children:[a.activepage,(0,e.jsx)("i",{className:"ti ti-chevrons-right flex-shrink-0 text-[#8c9097] dark:text-white/50 px-[0.5rem] overflow-visible rtl:rotate-180"})]})}),(0,e.jsx)("li",{className:"text-[0.813rem] text-defaulttextcolor font-semibold hover:text-primary dark:text-[#8c9097] dark:text-white/50 ","aria-current":"page",children:a.mainpage})]})]})})])},539111,a=>{"use strict";var e=a.i(616309),s=a.i(639146);a.s(["default",0,({title:a,code:r,children:d,customCardClass:o,customCardHeaderClass:t,customCardBodyClass:i,customCardFooterClass:l})=>{let[c,m]=(0,s.useState)(!1),n=(0,s.useRef)(`reference${Math.ceil(999*Math.random())}`);return(0,e.jsxs)("div",{className:`box ${o}`,children:[(0,e.jsxs)("div",{className:`box-header justify-content-between ${t}`,children:[(0,e.jsx)("div",{className:"box-title",dangerouslySetInnerHTML:{__html:a}}),(0,e.jsx)("div",{className:"prism-toggle",children:(0,e.jsxs)("button",{type:"button",className:"ti-btn !py-1 !px-2 ti-btn-primary !text-[0.75rem] !font-medium",onClick:()=>{m(!c)},children:["Show Code  ",(0,e.jsx)("i",{className:`${c?"ri-code-s-slash-line":"ri-code-line"} ms-2 align-middle inline-block`})]})})]}),(0,e.jsx)("div",{ref:n,className:`box-body ${i}`,style:{display:c?"none":"block"},children:s.default.Children.map(d,a=>s.default.cloneElement(a))}),(0,e.jsx)("div",{className:`box-footer !border-t-0 ${l}`,style:{display:c?"block":"none"},children:(0,e.jsx)("pre",{className:"language-html",children:(0,e.jsx)("code",{className:"language-html",children:r})})})]})}])},420974,a=>{"use strict";let e=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
{AvatarOffline.map((idx) => 
    (<span className={&#96;avatar avatar-&#36;{idx.class} 
        ...
        <img src={idx.src} alt="img" /></span>))}
</div>`,g=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<div className="box-body">
...
// End Prism Code//`;a.s(["avatar1",0,c,"avatar10",0,x,"avatar11",0,f,"avatar12",0,N,"avatar13",0,y,"avatar14",0,j,"avatar15",0,k,"avatar16",0,w,"avatar17",0,C,"avatar18",0,P,"avatar19",0,T,"avatar2",0,m,"avatar20",0,E,"avatar21",0,I,"avatar22",0,D,"avatar3",0,n,"avatar4",0,p,"avatar5",0,b,"avatar6",0,g,"avatar7",0,v,"avatar8",0,u,"avatar9",0,h,"border1",0,e,"border2",0,s,"border3",0,r,"border4",0,d,"border5",0,o,"border6",0,t,"border7",0,i,"border8",0,l])},814418,a=>{"use strict";var e=a.i(616309),s=a.i(193358),r=a.i(691665),d=a.i(539111),o=a.i(420974);a.s(["default",0,()=>(0,e.jsxs)("div",{children:[(0,e.jsx)(r.default,{title:"Borders"}),(0,e.jsx)(s.default,{currentpage:"Borders",activepage:"Utilities",mainpage:"Borders"}),(0,e.jsxs)("div",{className:"grid grid-cols-12 gap-6",children:[(0,e.jsx)("div",{className:"xl:col-span-6 col-span-12",children:(0,e.jsxs)(d.default,{title:"Borders",code:o.border1,children:[(0,e.jsx)("span",{className:"border dark:border-defaultborder/10 border-container"}),(0,e.jsx)("span",{className:"border-t dark:border-defaultborder/10 border-container"}),(0,e.jsx)("span",{className:"border-e dark:border-defaultborder/10 border-container"}),(0,e.jsx)("span",{className:"border-b dark:border-defaultborder/10 border-container"}),(0,e.jsx)("span",{className:"border-s dark:border-defaultborder/10 border-container"})]})}),(0,e.jsx)("div",{className:"xl:col-span-6 col-span-12",children:(0,e.jsxs)(d.default,{title:"Remove Borders",code:o.border2,children:[(0,e.jsx)("span",{className:"border-0 border-container"}),(0,e.jsx)("span",{className:"border dark:border-defaultborder/10 border-t-0 border-container"}),(0,e.jsx)("span",{className:"border dark:border-defaultborder/10 border-e-0 border-container"}),(0,e.jsx)("span",{className:"border dark:border-defaultborder/10 border-b-0 border-container"}),(0,e.jsx)("span",{className:"border dark:border-defaultborder/10 border-s-0 border-container"})]})})]}),(0,e.jsxs)("div",{className:"grid grid-cols-12 gap-6",children:[(0,e.jsx)("div",{className:"xl:col-span-5 col-span-12",children:(0,e.jsxs)(d.default,{title:"Border Widths",code:o.border3,children:[(0,e.jsx)("span",{className:"border-1 dark:border-defaultborder/10 border-container"}),(0,e.jsx)("span",{className:"border-container dark:border-defaultborder/10 border-2"}),(0,e.jsx)("span",{className:"border-container dark:border-defaultborder/10 border-4"}),(0,e.jsx)("span",{className:"border-container dark:border-defaultborder/10 border-8"})]})}),(0,e.jsx)("div",{className:"xl:col-span-7 col-span-12",children:(0,e.jsxs)(d.default,{title:"Border Colors",code:o.border4,children:[(0,e.jsx)("span",{className:"border border-container !border-primary"}),(0,e.jsx)("span",{className:"border border-container !border-secondary"}),(0,e.jsx)("span",{className:"border border-container !border-success"}),(0,e.jsx)("span",{className:"border border-container !border-danger"}),(0,e.jsx)("span",{className:"border border-container !border-warning"}),(0,e.jsx)("span",{className:"border border-container !border-info"}),(0,e.jsx)("span",{className:"border border-container !border-light"}),(0,e.jsx)("span",{className:"border border-container !border-black"}),(0,e.jsx)("span",{className:"border border-container !border-white"})]})})]}),(0,e.jsxs)("div",{className:"grid grid-cols-12 gap-6",children:[(0,e.jsx)("div",{className:"xl:col-span-6 col-span-12",children:(0,e.jsxs)(d.default,{title:"Border Color Styling",code:o.border5,children:[(0,e.jsxs)("div",{className:"mb-4",children:[(0,e.jsx)("label",{htmlFor:"exampleFormControlInput1",className:"form-label",children:"Email address"}),(0,e.jsx)("input",{type:"email",className:"form-control w-full !rounded-md !border-success",id:"exampleFormControlInput1",placeholder:"name@example.com"})]}),(0,e.jsx)("div",{className:"h4 pb-4 mb-4 text-danger border-b !border-danger",children:"Below Shows Danger Border"}),(0,e.jsx)("div",{className:"p-4 bg-info/10 border !border-info  !border-s-0 rounded-e-md mb-1",children:"Customizing borders with background colors"})]})}),(0,e.jsx)("div",{className:"xl:col-span-6 col-span-12",children:(0,e.jsxs)(d.default,{title:"Border With Opacity",code:o.border6,children:[(0,e.jsx)("div",{className:"border border-success  p-2 mb-2",children:"This is default success border"}),(0,e.jsx)("div",{className:"border border-success/75  p-2 mb-2",children:"This is 75% opacity success border"}),(0,e.jsx)("div",{className:"border border-success/50  p-2 mb-2",children:"This is 50% opacity success border"}),(0,e.jsx)("div",{className:"border border-success/25  p-2 mb-2 ",children:"This is 25% opacity success border"}),(0,e.jsx)("div",{className:"border border-success/10 p-2",children:"This is 10% opacity success border"})]})})]}),(0,e.jsxs)("div",{className:"grid grid-cols-12 gap-6",children:[(0,e.jsx)("div",{className:"xl:col-span-6 col-span-12",children:(0,e.jsxs)(d.default,{title:"Border Radius",customCardBodyClass:"!flex flex-wrap gap-2",code:o.border7,children:[(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-md",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-t-md",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-e-md",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-b-md",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-s-md",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-full",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img  rounded-full",alt:"..."})]})}),(0,e.jsx)("div",{className:"xl:col-span-6 col-span-12",children:(0,e.jsxs)(d.default,{title:"Sizes",customCardBodyClass:"!flex flex-wrap gap-2",code:o.border8,children:[(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-none",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-sm",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-md",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-lg",alt:"..."}),(0,e.jsx)("img",{src:"../../assets/images/media/media-58.jpg",className:"bd-placeholder-img rounded-xl",alt:"..."})]})})]})]})])}]);