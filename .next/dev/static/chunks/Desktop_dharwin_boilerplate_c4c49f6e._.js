...
const getPermissionDescription = (permission)=>{
    ...
    if (match) {
        ...
        const actionDesc = action === 'Create' ? 'create new records' : action === 'Edit' ? 'modify existing records' : action === 'Delete' ? 'remove records' : action.toLowerCase();
...
//# sourceMappingURL=Desktop_dharwin_boilerplate_c4c49f6e._.js.map